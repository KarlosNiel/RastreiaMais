...
export default function PacientesListLayout({
  children,
}: {
  ...
  function onSearchSubmit(e: FormEvent<HTMLFormElement>) {
    e.preventDefault();
    // TODO: integrar com busca global por paciente/CPF (router.push com ?q=)
  }
